...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			a3 = claim_element(div8_nodes, "A", { class: true, target: true });
		...
		h: function hydrate() {
			...
			add_location(h1, file, 9, 3, 253);
			attr_dev(h2, "class", "subtitle is-3");
			add_location(h2, file, 12, 3, 317);
			attr_dev(div0, "class", "container");
			add_location(div0, file, 8, 2, 226);
			attr_dev(div1, "class", "hero-body has-text-centered");
			add_location(div1, file, 7, 1, 182);
			attr_dev(section0, "class", "hero is-medium is-fullwidth is-danger is-bold");
			add_location(section0, file, 6, 0, 117);
			attr_dev(h3, "class", "title");
			add_location(h3, file, 20, 2, 533);
			attr_dev(p0, "class", "subtitle");
			add_location(p0, file, 21, 2, 570);
			attr_dev(div2, "class", "container");
			add_location(div2, file, 19, 1, 507);
			add_location(br, file, 25, 1, 654);
			attr_dev(i0, "class", "fas fa-coins fa-4x");
			add_location(i0, file, 31, 7, 847);
			attr_dev(span0, "class", "has-text-primary");
			add_location(span0, file, 30, 5, 808);
			attr_dev(h40, "class", "title is-4");
			add_location(h40, file, 33, 5, 900);
			attr_dev(p1, "class", "subtitle");
			add_location(p1, file, 34, 5, 944);
			attr_dev(div3, "class", "box");
			add_location(div3, file, 29, 4, 785);
			attr_dev(a0, "class", "column is-4");
			attr_dev(a0, "href", "https://bayarcepat.com");
			attr_dev(a0, "target", "_blank");
			add_location(a0, file, 28, 3, 711);
			attr_dev(i1, "class", "fas fa-shopping-bag fa-4x");
			add_location(i1, file, 40, 7, 1189);
			attr_dev(span1, "class", "has-text-primary");
			add_location(span1, file, 39, 5, 1150);
			attr_dev(h41, "class", "title is-4");
			add_location(h41, file, 42, 5, 1249);
			attr_dev(p2, "class", "subtitle");
			add_location(p2, file, 43, 5, 1294);
			attr_dev(div4, "class", "box");
			add_location(div4, file, 38, 4, 1127);
			attr_dev(a1, "class", "column is-4");
			attr_dev(a1, "href", "https://toko.dibumi.com");
			attr_dev(a1, "target", "_blank");
			add_location(a1, file, 37, 3, 1052);
			attr_dev(i2, "class", "fas fa-piggy-bank fa-4x");
			add_location(i2, file, 49, 7, 1499);
			attr_dev(span2, "class", "has-text-primary");
			add_location(span2, file, 48, 5, 1460);
			attr_dev(h42, "class", "title is-4");
			add_location(h42, file, 51, 5, 1557);
			attr_dev(p3, "class", "subtitle");
			add_location(p3, file, 52, 5, 1604);
			attr_dev(div5, "class", "box");
			add_location(div5, file, 47, 4, 1437);
			attr_dev(a2, "class", "column is-4");
			attr_dev(a2, "target", "_blank");
			add_location(a2, file, 46, 3, 1393);
			attr_dev(div6, "class", "columns");
			add_location(div6, file, 27, 2, 686);
			attr_dev(h43, "class", "title is-4");
			add_location(h43, file, 59, 5, 1817);
			attr_dev(p4, "class", "subtitle");
			add_location(p4, file, 60, 5, 1865);
			attr_dev(div7, "class", "box");
			add_location(div7, file, 58, 4, 1794);
			attr_dev(a3, "class", "column is-4 is-offset-4");
			attr_dev(a3, "target", "_blank");
			add_location(a3, file, 57, 3, 1738);
			attr_dev(div8, "class", "columns");
			add_location(div8, file, 56, 2, 1713);
			attr_dev(div9, "class", "container");
			add_location(div9, file, 26, 1, 660);
			attr_dev(section1, "class", "section has-text-centered");
			add_location(section1, file, 18, 0, 462);
			attr_dev(span3, "class", "title");
			add_location(span3, file, 71, 7, 2139);
			add_location(p5, file, 71, 4, 2136);
			attr_dev(p6, "class", "subtitle");
			add_location(p6, file, 72, 4, 2191);
			attr_dev(div10, "class", "column");
			add_location(div10, file, 70, 3, 2111);
			attr_dev(div11, "class", "columns");
			add_location(div11, file, 69, 2, 2086);
			attr_dev(div12, "class", "container");
			add_location(div12, file, 68, 1, 2060);
			attr_dev(section2, "class", "section has-background-white has-text-centered");
			add_location(section2, file, 67, 0, 1994);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
